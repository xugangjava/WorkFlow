...
public class SecuredResource extends ServerResource {
   ...
   * @param arguments arguments to replace the placeholders in the urlFragments, using the {@link java.text.MessageFormat}
  ...
  /**
   * @return the {@link org.restlet.data.MediaType} resolved from the given resource-name. Returns null if the type cannot
   ...
   * Returns null, if the query-parameter was not set.
   * 
   * @throws org.activiti.engine.ActivitiIllegalArgumentException when the query parameter is set but has cannot be converted to an integer
   */
   ...
   * Returns null, if the query-parameter was not set.
   * 
   * @throws org.activiti.engine.ActivitiIllegalArgumentException when the query parameter is set but has cannot be converted to a boolean
   */
   ...
   * Returns null, if the query-parameter was not set.
   * 
   * @throws org.activiti.engine.ActivitiIllegalArgumentException when the query parameter is set but has cannot be converted to a date
   */
